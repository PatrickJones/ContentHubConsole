...
{
    public class ConaEcommGraphicAssetDetailer : BaseDetailer
    {
        public ConaEcommGraphicAssetDetailer(IWebMClient webMClient, ICollection<FileUploadResponse> fileUploadResponses) : base(webMClient, fileUploadResponses)
        {
        }
